 ...
 */
function findErrorPattern(errorMessage: string): { message: string; suggestion: string } | undefined {
 ...
 */
export function formatError(error: Error, showDebug = false): string {
 ...
 */
export function handleError(error: Error, showDebug = false): void {
