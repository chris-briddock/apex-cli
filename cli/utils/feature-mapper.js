 ...
 * @returns {boolean}
 */
export function classMatchesFeature(className, feature) {
 ...
 * @param {object} mapping - Feature mapping with patterns
 * @returns {boolean}
 */
function matchesPattern(className, mapping) {
 ...
 * @param {string} className - Class name to check
 * @param {object} mapping - Feature mapping with prefixes
 * @returns {boolean}
 */
function matchesPrefix(className, mapping) {
 ...
 * @param {string} className - Class name with possible prefixes
 * @returns {string} Base class name without variant prefixes
 */
 ...
 * @param {Set<string>} classNames - Set of class names detected in the project
 * @returns {Set<string>} Set of feature names that are used
 */
export function findUsedFeatures(classNames) {
 ...
 * @param {Set<string>} unusedFeatures - Set of unused feature names
 * @returns {number} Estimated KB saved
 */
export function calculateSavings(unusedFeatures) {
  let totalSavings = 0;
 ...
 * @param {Set<string>} classNames - Set of class names detected
 * @param {object} currentConfig - Current configuration object
 * @returns {object} Analysis result with used, unused, and total features
 */
export function analyzeFeatureUsage(classNames, currentConfig) {
