...
import {
  ...
  updateConfigFile,
  validateChanges
} from '../../../cli/utils/config-modifier.ts';
...
describe('config-modifier', () => {
  ...
  describe('formatDiff', () => {
    it('should format diff with disabled features', () => {
      const diff = {
        changes: [
          { feature: 'grid', oldValue: true, newValue: false, action: 'disable' as const },
          { feature: 'transforms3d', oldValue: true, newValue: false, action: 'disable' as const }
        ],
        totalChanges: 2,
        disabled: [
          { feature: 'grid', oldValue: true, newValue: false, action: 'disable' as const },
...
export default {
  ...
  describe('buildUpdatedConfig', () => {
    it('should create updated config with disabled features', () => {
      ...
      assert.strictEqual((updated.features as Record<string, unknown>).display, true);
      assert.strictEqual((updated.features as Record<string, unknown>).grid, false);
      assert.strictEqual((updated.features as Record<string, unknown>).spacing, true);
      assert.strictEqual((updated.colors as Record<string, unknown>).primary, 'blue');
    });
  ...
  describe('validateChanges', () => {
    it('should warn about disabling critical features', () => {
      const diff = {
        changes: [
          { feature: 'display', oldValue: true, newValue: false, action: 'disable' as const },
          { feature: 'spacing', oldValue: true, newValue: false, action: 'disable' as const }
        ],
        totalChanges: 2,
        disabled: [
          { feature: 'display', oldValue: true, newValue: false, action: 'disable' as const },
    ...
    it('should warn when many features disabled', () => {
      const diff = {
        changes: [
          { feature: 'grid', oldValue: true, newValue: false, action: 'disable' as const },
          { feature: 'transforms3d', oldValue: true, newValue: false, action: 'disable' as const },
          { feature: 'filters', oldValue: true, newValue: false, action: 'disable' as const },
          { feature: 'animations', oldValue: true, newValue: false, action: 'disable' as const },
          { feature: 'transitions', oldValue: true, newValue: false, action: 'disable' as const },
          { feature: 'shadows', oldValue: true, newValue: false, action: 'disable' as const },
          { feature: 'opacity', oldValue: true, newValue: false, action: 'disable' as const },
          { feature: 'overflow', oldValue: true, newValue: false, action: 'disable' as const },
          { feature: 'objectFit', oldValue: true, newValue: false, action: 'disable' as const },
          { feature: 'cursor', oldValue: true, newValue: false, action: 'disable' as const },
          { feature: 'userSelect', oldValue: true, newValue: false, action: 'disable' as const }
        ],
        totalChanges: 11,
        disabled: [
          { feature: 'grid', oldValue: true, newValue: false, action: 'disable' as const },
